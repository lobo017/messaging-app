...
function App() {
  ...
  const [buttonMode, setButtonMode] = useState("Send"); // State to track button mode
  ...
  const scenarios = [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "b", text: "Seriously? You're not the only smart person around. Stop acting like you are.", response: "You just don't get it, do you? I'm tired of being surrounded by people who can't see the truth." },
    ...
    <div className="container">
      ...
      <div className="app-container">
        ...
        <div className="chat-window">
          ...
          {/* Replace Send button with Next button */}
          <div className="input-area">
            {/* Change button text to "Next" and disable based on inputDisabled */}
            <button onClick={handleNextClick} disabled={inputDisabled}>
              Next
            </button>
          </div>
        </div>
      ...
      {/* Choices Area - Display static "Click Next" message */}
      <div className="choices-area">
        {/* Replace choices with a static message */}
        <div className="choice-prompt">
          <div className="choice-option">Click Next</div>
        </div>
      </div>
    </div>
  );
